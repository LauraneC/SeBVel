...
class Shadow:
    ...
    def __init__(self, 
        ...
        This class is based on Steger, C. R., Steger, B., & Schär, C. (2022). HORAYZON v1. 2: an efficient and flexible ray-tracing algorithm to compute horizon and sky view factor. Geoscientific Model Development, 15(17), 6817-6840.
        Parameters
        ----------
        ...
        with rio.open(file_dem, 'r') as src:
            if src.crs.to_epsg() == 4326:
                def get_utm_epsg(lon, lat):
                    """Get the UTM EPSG code based on longitude and latitude."""
